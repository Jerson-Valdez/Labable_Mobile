...
1. Clone the Repository:
  git clone https://github.com/yourusername/Labable_Mobile-lms.git
cd labable-lms
...
| **Backend** | Javascript, Postman, Java | Handling API requests, business logic, and server operations. |
| **Database** | Firebase | Robust and reliable data storage for all transactions and records. |
| **Tools** | Git, GitHub, vs.code, Android Studio | Version control and collaborative development platform. |
